...
source <(curl -fsSL https://raw.githubusercontent.com/savino/ProxmoxVE/refs/heads/main/misc/core.func)
...
for container in $CHOICE; do
  ...
  script=$(curl -fsSL https://raw.githubusercontent.com/savino/ProxmoxVE/main/ct/${service}.sh)
