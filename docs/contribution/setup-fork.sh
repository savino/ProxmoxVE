...
# upstream   https://github.com/savino/ProxmoxVE.git (fetch)
# upstream   https://github.com/savino/ProxmoxVE.git (push)
```
...
print_info "Upstream: https://github.com/savino/ProxmoxVE"
echo ""
