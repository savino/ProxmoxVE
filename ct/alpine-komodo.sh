...
ADDON_SCRIPT="https://raw.githubusercontent.com/savino/ProxmoxVE/main/tools/addon/komodo.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/savino/ProxmoxVE/main/tools/addon/komodo.sh)"
MIGRATION_EOF
