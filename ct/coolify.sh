...
ADDON_SCRIPT="https://raw.githubusercontent.com/savino/ProxmoxVE/main/tools/addon/coolify.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/savino/ProxmoxVE/main/tools/addon/coolify.sh)"
MIGRATION_EOF
